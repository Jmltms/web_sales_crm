...
import PipelineCardModal from "./ReassignLeadsCardModal";
import ReassignLeadsCardModal from "./ReassignLeadsCardModal";
// import ReassignLeadsStatusModal from "./ReassignLeadsStatusModal";

const ReassignLeadsCard = ({ lead, index }) => {
  console.log(lead);
                ...
                <div>
                  <div className="flex justify-between space-x-32">
                    <div>
                      ...
                      <ReassignLeadsCardModal lead={lead} />
...
export default ReassignLeadsCard;
