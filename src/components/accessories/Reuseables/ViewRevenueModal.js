...
// import { useEditRevenueMutation } from "../../../store";

// const ViewRevenueModal = ({ leadId, status }) => {
...
//   const monthlyFee = monthRange * input.msf;
//   const projected_revenue = parseInt(input.otf) + parseInt(monthlyFee);

//   let content;
//   let cardContent = [];

//   // looping for displaying the month on card
//   for (
...
//   // handle editing of data and sent to back end
//   const handleEdit = () => {
//     let element;
//     let arr = [];
//     for (let index = month.start; index <= month.end; index++) {
...
//     console.log(input);
//     const editRev = editRevenue(input).unwrap();
//     if (editRev.success === true) {
//       toast.success(editRev.message, {
//         position: "top-center",
//         autoClose: 5000,
//         hideProgressBar: false,
//         closeOnClick: true,
...
//     content = (
//       <Button size="sm" className="flex items-center bg-blue-700">
...
//                 name="otf"
//                 type="number"
//                 defaultValue={parseInt(revenueD.otf)}
//                 onChange={handleChange}
//               />
//               <Input
//                 label="Monthly Service Fee"
//                 name="msf"
//                 type="number"
//                 defaultValue={parseInt(revenueD.msf)}
//                 onChange={handleChange}
//               />
//             </div>
//             <Typography className=" text-center text-blue-gray-800 my-3">
...
//                       dateFormat="MM/yyyy"
//                       showMonthYearPicker
//                       placeholderText="Change month start"
//                     />
//                   </div>
//                 )}
//               </div>
...
//                       dateFormat="MM/yyyy"
//                       showMonthYearPicker
//                       placeholderText="Change month end"
//                     />
//                   </div>
//                 )}
//               </div>
...
//               )}
//             </div>
//             <div className=" grid grid-cols-2 mx-10 gap-3 mt-2">
//               {cardContent?.map((obj) => (
